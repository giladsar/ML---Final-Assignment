...
#Interesting. Although I can't asses the confidence of such results, it's seems that somewhere around ~5000 messages received there's a decrease in the number of average prediction
...
rndf_xplnr <- explain(boost_fit, label = "Boosting",
                     data = select(Tinder.train, -nrOfGhostingsAfterInitialMessage),
                     y = Tinder.train$nrOfGhostingsAfterInitialMessage)
