...
עבודה זו תבחן האם הנטיה לעשות למישהו גוסטינג( ניתוק קשר ללא התראה מוקדמת) לאחר קבלת ההודעה הראשונה יכולה להיות מנובאת מהתנהגויות אחרות בפלטפורמה ונתונים דמוגרפים.
